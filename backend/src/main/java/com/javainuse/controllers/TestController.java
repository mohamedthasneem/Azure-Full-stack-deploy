...
EmployeeRepository repository;
  ...
  public Employee postEmployee(@RequestBody Employee employee) {
    ...
    Employee _employee = repository.save(new Employee(employee.getEmpId(), employee.getName(), employee.getDesignation(), employee.getSalary()));
    return _employee;
  }
 
  @DeleteMapping("/employeelist/{empId}")
